...
create table address_ (id integer not null auto_increment, city varchar(255), country varchar(255), street varchar(255), street_number integer, primary key (id)) engine=InnoDB;
create table category (product_category_id integer not null auto_increment, description varchar(4028), name varchar(255), primary key (product_category_id)) engine=InnoDB;
...
create table product (product_id integer not null auto_increment, description varchar(500), image varchar(255), name varchar(255), price decimal(19,2),producer varchar(255), product_category_product_category_id integer, primary key (product_id)) engine=InnoDB;
...
create table user (user_id integer not null auto_increment, email_address varchar(255), fist_name varchar(255), last_name varchar(255), password varchar(255), username varchar(255), role_role_id integer, image_id integer, address_id integer, primary key (user_id)) engine=InnoDB;
